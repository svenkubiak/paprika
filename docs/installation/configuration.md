...
| `PERSISTENCE_MONGO_PASSWORD` | MongoDB password. | Docker: yes, a random password is generated for that same scoped application user. Standalone: **no** — left as `CHANGE_ME`. |
